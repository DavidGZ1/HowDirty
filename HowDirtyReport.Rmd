...
```{r plot_risk_summ_sampleset, fig.width= 4, fig.height=3}
...
```{r plot_conta_summ_sample_risk_bysample, warning=FALSE, fig.width= 10, fig.height=4}
...
```{r plot_conta_summ_sample_risk_byabundance, warning=FALSE, fig.width= 10, fig.height=4}
...
```{r plot_ContaminantGroupArea, results='asis', fig.height=5, fig.width=8, warning=FALSE}
...
```{r plot_ContaminantGroupPseudoChromato, results='asis', fig.height=4, fig.width=8, warning=FALSE}
