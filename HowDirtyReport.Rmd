...
conta_summ_contaminant_condition <-
...
```{r plot_ContaminantGroupCondition}
#dotplot
## ContaminantGroup 
dot_plot_conta_summ_contaminant_condition_risk_contaminantgroup <-
  plot_condition_risk_contaminant(conta_summ_contaminantgroup_sample,
                              order_x = "Condition", order_y = "Abundance", show_zeros = FALSE)



print_plot_or_plotly(dot_plot_conta_summ_contaminant_condition_risk_contaminantgroup,
                     height_plotly = 400, width_plotly = 1000)
```

## Sample dotplot

```{r plot_ContaminantGroupSample_abundance, fig.height=8, fig.width=8, }
#dotplot
## ContaminantGroup 
...
```{r plot_abundance_contaminantgroup_sample, fig.height=8, fig.width=8, }
...
```{r plot_ContaminantGroupArea, results='asis', fig.height=6, fig.width=10, warning=FALSE}
...
for (i in 1:length(plot_abundance_contaminantgroup_list)) {
  ...
  if(params$PlotsInteractive == TRUE){
    ...
    plot_abundance_contaminantgroup_list[[i]]
  }
  }
  cat('\n\n')
}
...
```{r plot_ContaminantGroupPseudoChromato, results='asis', fig.height=5, fig.width=8, warning=FALSE}
...
for (i in 1:length(plot_seudochromatogram_contaminantgroup_list)) {
  ...
  if(params$PlotsInteractive == TRUE){
    ...
    plot_seudochromatogram_contaminantgroup_list[[i]]
  }
  }
  cat('\n\n')
}
