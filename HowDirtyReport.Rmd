...
params:
  ...
  AnnotationFile:
    ...
    value: data/samples_annotation_2021-231.csv 
  RefThresholdsFile:
    label: "Reference threshold file" # file directory/name or FALSE
    value: data/2021-231_FASP_filters_report_contaminants_20230712_1821.xlsx 
  OutputDirectory:
