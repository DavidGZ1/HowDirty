...
# Results: Summary risk evaluation and top contaminants
...
* Below is shown the summary of contaminant risk evaluation for each sample in plot and table formats
* The table can also be found in `r filedir_report` --> conta_summ_sample.

### Plot: Total contamination per sample
