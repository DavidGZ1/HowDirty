...
load_conta_results <- function(file_report_skyline, simplify_AnalyteGroup = TRUE){
  output <- 
...
# load_conta_results(file_report_skyline = params$PeakAreasContaminantsFile) %>% 
#   names
...
raw_conta <- load_conta_results(file_report_skyline = params$PeakAreasContaminantsFile)
