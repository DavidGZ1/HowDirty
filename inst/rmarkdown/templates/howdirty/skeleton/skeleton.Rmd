...
```{r plot_AnalyteGroupArea, results='asis', fig.height=8, fig.width=8, warning=FALSE}
...
```{r plot_AnalyteGroupPseudoChromato, results='asis', echo=FALSE, fig.height=8, fig.width=8, warning=FALSE}
